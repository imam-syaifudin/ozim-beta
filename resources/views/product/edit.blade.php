    ...
    <div class="container">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-danger">Form Edit Product</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('product.update',$product->id) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-check">
                        ...
                        id="flexRadioDefault1" @if( $product->kategori == 'ikancupang') checked @endif>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="kategori" value="alatperawatan"
                            id="flexRadioDefault2" @if( $product->kategori == 'alatperawatan') checked @endif>
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 300px" name="deskripsi">{{ $product->deskripsi }}</textarea>
